...
export default function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const { data: post, isLoading, refetch } = api.blog.getById.useQuery(
    { id: paramId! }, 
    { enabled: !!paramId }
  );
      ...
      <div className="">
        ...
        <div className="bg-panel border border-line rounded-lg bevel overflow-hidden">
          <div className="border-b border-line bg-subtle p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">Содержание статьи</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="bg-panel border border-line rounded-lg p-4 bevel">
            <h3 className="font-semibold mb-3 text-neon">Метаданные</h3>
          ...
          <div className="bg-panel border border-line rounded-lg p-4 bevel">
            <h3 className="font-semibold mb-3 text-cyan">Быстрые действия</h3>
