...
export default function EditBlogPostPage({ params }: EditBlogPostPageProps) {
  ...
  const handleTitleChange = (newTitle: string) => {
    ...
    if (post && (slug === post.slug || slug === generateSlugFromTitle(title))) {
    ...
    return (
      <div className=" flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-soft mb-4">Возможно, пост был удален или перемещен</p>
          <Link
            href="/blog"
        ...
        <form onSubmit={(e) => handleSubmit(e)} className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">
                  URL слаг <span className="text-red-400">*</span>
                </label>
                <input
                  type="text"
                  value={slug}
                ...
                {slug !== post.slug && (
                  <p className="text-xs text-yellow-400 mt-1">
                    ⚠️ Изменение слага может нарушить существующие ссылки
                  </p>
                )}
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-panel border border-line rounded-lg p-4 bevel">
                <h3 className="font-semibold mb-3 text-soft">Информация</h3>
                <div className="space-y-2 text-sm">
                  <div>
                    <span className="text-soft">Создан:</span>
                  ...
                  <div>
                    <span className="text-soft">Автор:</span>
                    <div className="text-xs mt-1">
                  ...
                  {post.publishedAt && (
                    <div>
                      <span className="text-soft">Опубликован:</span>
                      <div className="text-xs mt-1">
              ...
              {/* Статус публикации */}
              <div className="bg-panel border border-line rounded-lg p-4 bevel">
                <h3 className="font-semibold mb-4 text-neon">Публикация</h3>
                <div className="space-y-4">
                  ...
                  {post.published !== published && (
                    <div className="text-xs text-yellow-400">
                      {published ? "📢 Пост будет опубликован" : "📝 Пост станет черновиком"}
                    </div>
                  )}
                </div>
              </div>
              ...
              {/* Теги */}
              <div className="bg-panel border border-line rounded-lg p-4 bevel">
                <h3 className="font-semibold mb-4 text-cyan">Теги</h3>
                ...
                {tags?.length === 0 && (
                  <p className="text-soft text-sm">
                    Теги не созданы. Создайте теги в настройках блога.
                  </p>
                )}
              </div>
              ...
              <div className="bg-panel border border-line rounded-lg p-4 bevel space-y-3">
                ...
                >
                  {updatePostMutation.isPending ? "Сохраняю..." : "Сохранить изменения"}
                </button>
