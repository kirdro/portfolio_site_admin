...
export function DatabaseStatus({
	...
	const обработчикСозданияБекапа = useCallback(() => {
		if (
			confirm(
				'Создать резервную копию базы данных? Это может занять несколько минут.',
			)
		) {
	...
	const обработчикОптимизацииБД = useCallback(() => {
		if (
			confirm(
				'Оптимизировать базу данных? Это может временно замедлить работу системы.',
			)
		) {
			...
			<div className='bg-subtle border border-line rounded-lg bevel p-6'>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  ...
                  bg-${получитьЦветСтатуса(systemStatus.memory.usage)}`}
								style={{
									width: `${systemStatus.memory.usage}%`,
								}}
							></div>
						</div>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
					...
					>
						<div className='text-center'>
							<div className='text-2xl mb-2 group-hover:text-green-400 transition-colors'>
								💾
							</div>
							<div className='font-medium text-base mb-1'>
								Создать бекап
					...
					>
						<div className='text-center'>
							<div className='text-2xl mb-2 group-hover:text-cyan transition-colors'>
								⚡
							</div>
							<div className='font-medium text-base mb-1'>
								Оптимизировать
					...
					>
						<div className='text-center'>
							<div className='text-2xl mb-2 group-hover:text-yellow-400 transition-colors'>
								🔄
							</div>
							<div className='font-medium text-base mb-1'>
								Перезагрузить
