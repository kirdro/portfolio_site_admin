	...
	return (
		...
		>
			...
			<div className='aspect-video bg-panel relative overflow-hidden'>
				...
				{project.featured && (
					<div
						className='absolute top-2 right-2 bg-neon/20 border border-neon
				...
				<div
					className='absolute inset-0 bg-bg/80 opacity-0 group-hover:opacity-100
			...
			<div className='p-4'>
				{/* Заголовок */}
				<h3
					className='font-bold text-base mb-2 truncate group-hover:text-neon
                     transition-colors'
				>
					{project.title}
				</h3>
				...
				<div className='flex items-center justify-between text-xs text-soft'>
					<div className='font-mono'>{форматированнаяДата}</div>
